...
user in an INI file next to PortExpertPortable.exe called PortExpertPortable.ini.
...
copy AppNamePortable.ini from this directory to PortExpertPortable.ini next to
PortExpertPortable.exe. The options in the INI file are as follows:
